...
<div class="container mx-auto px-6 py-4">
    ...
    <div class="post_content">
        ...
        <?php else: ?>
            <a class="user" href="?action=user&id=<?php echo $post['author_id']; ?>">
                <img src="<?php echo $post['photo']; ?>" />
        ...
        <div class="txt"><?php echo htmlspecialchars($post["content"]) ?></div>
        <div class="ld">
            <span class="like-btn">
                ...
                <span class="nums"><?php echo $post["likes"]; ?></span>
            ...
            <p class="date"><?php $date = new DateTime($post["date"]); echo $date->format('F j, Y'); ?></p>
        </div>
...
<script>
    ...
    like.onclick = () => {
        ...
        <?php # $PostController->addLike($post["id"]); ?>
        setTimeout(()=>{
