          ...
          if (isset($_SESSION['user_id'])) {
            echo '
              ...
              <div class="profile_down">
                  <img src="https://api.dicebear.com/9.x/thumbs/svg?seed=rami" alt="Avatar" class="avatar" onclick="toggleMenu()">
                  <div id="dropdown-menu" class="dropdown-menu">
                      <a href="?action=profile&name=<?php echo $_SESSION["user_id"]; ?>">
            ...
            echo '<a class="lk" href="?action=login">Sign in</a>';
            echo '<a class="lk" href="?action=register">Sign up</a>';
          }
        ?>
      </div>
    </nav>
