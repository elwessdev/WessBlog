            ...
            <?php if ($user): ?>
                ...
                <div class="infos">
                    <div class="profile_sec">
                        ...
                        <?php else: ?>
                            <?php if(!$isFollow): ?>
                                <button class="set" id="follow-btn" onclick="followBtn(<?php echo $user['id'] ?>,<?php echo $_SESSION['user_id'] ?>,'<?php echo $_SESSION['user_photo'] ?>','<?php echo $_SESSION['user_name'] ?>')">
...
<script lang="javascript">
    function followBtn(followedID,myID,followedProfile,followedName){
        ...
        .then(data=>{
            ...
            if(!data){
                addNotification(followedID,myID,followedProfile,followedName);
    ...
    function addNotification(followedID,myID,followedProfile,followedName){
        ...
        fetch("app/helpers/Notifications.php",{
            ...
            body: JSON.stringify({action: "new", from_id: myID, to_id: followedID, content: NotifContent})
        })
        .then(res=>res.text())
        .then(data=>{
            if(!data){
