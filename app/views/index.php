...
<div class="container mx-auto px-6 py-4">
    ...
    <main>
        <div class="main-article">
            <div class="img" style="background-image: url('https://katen-template.netlify.app/html/images/posts/featured-lg.jpg')"></div>
            <div class="article-content">
                <span class="category">Inspiration</span>
                <span class="category">Lifestyle</span>
                <h1>5 Easy Ways You Can Turn Future Into Success</h1>
        ...
        <div class="trading">
            ...
            <div class="articles">
                <div class="sidebar-article">
                    <img src="https://katen-template.netlify.app/html/images/posts/editor-sm-2.jpg" alt="iPhone">
                    <div class="article-info">
                        <p>3 Easy Ways To Make Your iPhone Faster</p>
                        <span>29 March 2021</span>
                    </div>
                </div>
                <div class="sidebar-article">
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
                            <div class="user">
                                ...
                                <a href="?action=profile&name=<?php echo $post['author_name']; ?>">
